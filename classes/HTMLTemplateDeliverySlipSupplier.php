...
class HTMLTemplateDeliverySlipSupplier extends HTMLTemplateDeliverySlip
{
    public function getContent()
    {
        ...
        if (isset($this->order_invoice->id_supplier_filter)) {
            $order_details = array_filter($order_details, function ($order_detail) {
                return $order_detail['id_supplier'] == $this->order_invoice->id_supplier_filter;
            });
        }
